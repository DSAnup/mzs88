			...
			<div class="main col-md-12">
				...
				<table id="applicant" class="display table table-hover table-striped" style="width:100%">
					...
					<cfoutput query="qTransactionSelect">
						...
						<cfset daysDifference = DateDiff("d", transactionDate, currentDate)>
						<tr>
							...
							<td>
								<cfif qTransactionSelect.Credit gt 1>
									#qTransactionSelect.Note#
								</cfif>
							</td>
							<td>
								<cfif qTransactionSelect.Debit gt 1>
									#qTransactionSelect.Note#
								</cfif>
							</td>
							<td>
								<cfif daysDifference lte 1>
