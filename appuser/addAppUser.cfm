        ...
        <div class="container">
            <div class="row">
                ...
                <div class="main col-md-12">
					...
					<form id="validate-1" role="form" class="form-horizontal" action="partialIndex.cfm?area=appuser&action=addAppUserAction"  method="post" target="formpost" enctype="multipart/form-data">                      
