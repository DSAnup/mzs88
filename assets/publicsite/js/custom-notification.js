...
function showSuccessMessage (message, successDiv, successMessage) {

	
	if (successDiv === undefined ||  successDiv == '')
...
function showErrorMessageReset (message, errorDivReset, errorMessageReset) {
	
	if (errorDivReset === undefined ||  errorDivReset == '')
		errorDivReset = 'errorDivReset';
		
	if (errorMessageReset === undefined || errorMessageReset == '')
		errorMessageReset = 'errorMessageReset';
	
		
	document.getElementById(errorMessageReset).innerHTML = message;
	document.getElementById(errorDivReset).style.display = 'block';
}
