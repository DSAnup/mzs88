                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card mt-4">
                            <div class="card-header bg-img p-5 position-relative">
                                ...
                                <h4 class="text-white text-center mb-0">Sign In<br/> <br>SMS Cast</h4>
                            </div>
                            ...
                            <div class="card-body p-4 mt-2">
                                <form method="post" action="partialIndex.cfm?area=login&action=loginaction" target="formpost" >
									<!---success alert --->
									<div class="alert alert-success alertHidden" id="successDiv"></div>
                                    ...
                                    <div class="form-group mb-3">
                                        <input class="form-control" type="email" name="email" required  placeholder="Username" value="">
                                    </div>
